...
if cocoFlag
    ...
    RecLabelIdxs = (gTruth.LabelDefinitions.Type == labelType.Rectangle);
    validCOCOLabelDefIdxs = polyLabelIdxs | pixelLabelIdxs | RecLabelIdxs;
...
for i = 1:numImages
    ...
    imageLastModifiedDate(i) = datetime('now','Format', 'yyyy-MM-dd hh:mm:ss');
end
